...
- **Project override:** JobPilot uses Tailwind CSS v4 per `context/ui-tokens.md` and `context/ui-rules.md`. Do not downgrade to Tailwind CSS 3.4.
...
- **Project:** **job-pilot** (API base `https://87dtz96z.ap-southeast.insforge.app`)
